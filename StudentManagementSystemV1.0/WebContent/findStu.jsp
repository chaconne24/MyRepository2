    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-body">
            ...
            <div class="layui-card" style="margin-top: 20px;margin-left: 10px;">
                <form class="layui-form" action="FindStuServlet">
				...
				<table class="layui-table">
						<thead>
						    <tr>
						      ...
						      <th lay-data="{field:'sex', width:170}">性别</th>
						      <th lay-data="{field:'age', width:170}">年龄</th>
						    </tr> 
						</thead>
						<tbody>
							<tr>
								<c:if test="${requestScope.stuinfo == null}">
									<td>没有找到！</td>
								</c:if>
								<c:if test="${requestScope.stuinfo != null}">
									<td>${requestScope.stuinfo.id}</td>
									<td>${requestScope.stuinfo.name}</td>
									<td>${requestScope.stuinfo.sex}</td>
							      	<td>${requestScope.stuinfo.age}</td>	
								</c:if>
						   	</tr>
						</tbody>
					</table>
