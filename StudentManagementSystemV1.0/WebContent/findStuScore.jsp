    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-body">
            ...
            <div class="layui-card" style="margin-top: 20px;margin-left: 10px;">
                <form class="layui-form" action="FindStuScoreServlet">
					<div class="layui-form-item">
				  	...
				  	<div class="layui-form-item">
				    	...
				    	<div class="layui-form-mid layui-word-aux">此两项必填</div>
				  	</div>
				  	<div class="layui-form-item">
				    	<div class="layui-input-block">
				...
				<table class="layui-table">
						<thead>
						    <tr>
						      ...
						      <th lay-data="{field:'java', width:100}">Java</th>
						      <th lay-data="{field:'python', width:100}">Python</th>
						      <th lay-data="{field:'SQL', width:100}">SQL</th>
						      <th lay-data="{field:'Linux', width:100}">Linux</th>
						      <th lay-data="{field:'sum', width:100}">总分</th>
						      <th lay-data="{field:'average', width:100}">平均分</th>
						    </tr> 
						</thead>
						<tbody>
							<tr>
								<c:if test="${requestScope.stuScoreinfo == null}">
									<td>没有找到！</td>
								</c:if>
								<c:if test="${requestScope.stuScoreinfo != null}">
									<td>${requestScope.stuScoreinfo.id}</td>
									<td>${requestScope.stuScoreinfo.name}</td>
									<td>${requestScope.stuScoreinfo.java}</td>
							      	<td>${requestScope.stuScoreinfo.python}</td>	
							      	<td>${requestScope.stuScoreinfo.sql}</td>	
							      	<td>${requestScope.stuScoreinfo.linux}</td>	
							      	<td>${requestScope.stuScoreinfo.sum}</td>	
							      	<td>${requestScope.stuScoreinfo.average}</td>	
								</c:if>
						   	</tr>
						</tbody>
					</table>
